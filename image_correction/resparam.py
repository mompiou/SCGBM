# -*- coding: utf-8 -*-
"""
Created on Wed Mar 31 16:37:11 2021
...
def resunet_param(epochs_param, lr_ini_param,decay_factor_param,step_size_param):
    ...
    lr_sched = step_decay_schedule(initial_lr=lr_ini_param, decay_factor=decay_factor_param, step_size=step_size_param)
    
    
    
    csv_logger = CSVLogger('training_resUnet-markers_3.log', separator=",", append=True)
